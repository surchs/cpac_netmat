...
class Analysis(object):
    ...
    def prepareNetworks(self):
        ...
        for network in self.mask.networkNodes.keys():
            ...
            print('Done preparing and running' + network + ' network')
...
class Network(object):
    ...
    def makeRuns(self):
        ...
        for cvInstance in self.cvObject:
            ...
            run.prepareRun()
            # and do the other stuff too while we are at it
        ...
        print('Reading back runs for ' + self.name + ' network')
