...
class Subject(object):
    ...
    def addDerivativePath(self, derivativeName, derivativePath):
        '''
    ...
    def makeDerivative(self, derivative=None):
        ...
        print 'running', self.pipeline, self.mask.name, self.name
        for derivative in selection:
            filePath = self.derivativePath[derivative]
            tempDerivative = Derivative(derivative)
            tempDerivative.makeFeature(filePath, self.mask)

            self.derivatives[tempDerivative.derivative] = tempDerivative

    def selectDerivative(self, mask, derivative):
        '''
        Method to choose one of the derivatives for a given mask and store it
...
class Mask(object):
    ...
    def sameSame(self, compareMask):
        ...
        if isinstance(compareMask, Mask):
            ...
            if (self.mask == compareMask.mask and
